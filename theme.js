...
class ThemeManager {
  ...
  // Update music icon color and icon based on theme
updateMusicIcon() {

  console.log('Updating music icon for theme:', this.config.darkMode ? 'dark' : 'light');
    if (this.elements.musicIcon) {
        // Update icon style
        this.elements.musicIcon.classList.remove("fa-music", "fa-headphones");
        this.elements.musicIcon.classList.add(
            this.config.darkMode ? "fa-headphones" : "fa-music"
        );
